...
from common.variables import DEFAULT_PORT, MAX_CONNECTIONS, ACTION, TIME, \
    ...
    MESSAGE_TEXT, RESPONSE_400, DESTINATION, RESPONSE_200, EXIT, SHOW
...
def process_client_message(message, messages_list, client, clients, names):
    ...
    # Ответ не требуется.
        ...
        return
    # -------------
    elif ACTION in message and message[ACTION] == SHOW and TIME in message:
        print('работает')
        msg = []
        for i in names.keys():
            msg.append(i)
        ...
        msg = ' '.join(msg)
        send_message(client, create_show_message(msg))
